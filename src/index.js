      ...
      this.props.show?
        <ScrollView style={styles.masker} keyboardDismissMode={'on-drag'}>
          <View style={[styles.container,this.props.style]}>
            {this.props.title?(typeof this.props.title==='string'?<Text style={[styles.title, this.props.titleStyle]}>{this.props.title}</Text>:this.props.title):null}
            {this.props.text?(typeof this.props.text==='string'?<Text style={[styles.text, this.props.textStyle]}>{this.props.text}</Text>:this.props.text):null}
            {myContent}
